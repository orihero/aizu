...
Invoked by the ``job_runner`` supervisor as::
    ...
    python -m aizu.worker.job_child --spec-file <path>
...
def main(argv: Optional[list] = None) -> int:
    ...
    parser = argparse.ArgumentParser(prog="aizu.worker.job_child")
    ...
    # Configure logging AFTER we know the spec is readable; AIZU_RUN_ID is already

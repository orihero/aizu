...
class YouTubeSession:
    ...
    def _process_comments(self, reel: Reel) -> int:
        ...
        # video walk cannot fire mid-batch and the run overshoots by up to the
        ...
        # WORST CASE OF THE SIX: the Data API is called with maxResults=100, so one
        # relevant video can add up to 100 matches in the caller's single increment.
        stopped_early = False
        for comment in comments:
            ...
            if res.is_match:
                ...
                # line from the grounded fields plus the video title/description when it didn't.

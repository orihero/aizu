...
window.CS_I18N.uz = {
  ...
  'faq.2.a':
    'Har bir lidda: u kim, oʻz soʻzlari bilan nima soʻragan, qachon soʻragan va unga toʻgʻridan-toʻgʻri qanday javob berish mumkin. Oʻsha kuniyoq, kontekst bilan yozish uchun yetarli. Taxmin ham, qazish ham kerak emas.',
  ...
  'faq.5.a':
    'Birinchi lidlar odatda biznesingizni tavsiflaganingizdan keyin bir necha kun ichida keladi, soʻng haftama-hafta davom etadi. Free tarifidan boshlang: oyiga oʻnta saralangan lid — bir dollar sarflamasdan farqni sezish uchun yetarli.',
